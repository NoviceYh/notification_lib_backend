...
public class EmailChannelSender implements ChannelSender {
    ...
    public DeliveryResult send(NotificationRequest request) {
        ...
        if (request.channel() != Channel.EMAIL) {
            ...
            throw new ValidationException("EmailChannelSender solo acepta canal EMAIL");
        }
    ...
    private EmailPayload extractEmailPayload(NotificationRequest request) {
        if (request.payload() == null) {
            ...
            throw new ValidationException("El payload no puede ser null para EMAIL");
        }
        if (!(request.payload() instanceof EmailPayload emailPayload)) {
            ...
            throw new ValidationException("Payload inválido: se esperaba EmailPayload para canal EMAIL");
        }
        return emailPayload;
    }
}
